...
#Create a planetary system class that takes a star as an argument, 
# has the ability to add planets to the system, and can print all the planets in the system.
